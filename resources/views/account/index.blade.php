        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="alert alert-danger">
                    <ul>
                        @if(!empty($not_linked_payments))
                            <li>{!! __('account.payments_not_linked_with_account', ['payments' => $not_linked_payments]) !!} <a href="{{action('App\Http\Controllers\AccountReportsController@paymentAccountReport')}}">@lang('account.view_details')</a></li>
                        @endif
                    </ul>
                </div>
            </div>
                ...
                <div class="tab-content">
                                ...
                                @component('components.widget')
                                    ...
                                    <div class="col-md-8">
                                        <button type="button" class="btn btn-primary btn-modal pull-right" 
                                            ...
                                            data-href="{{action('App\Http\Controllers\AccountController@create')}}">
                    ...
                    <div class="tab-pane" id="account_types">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary btn-modal pull-right" 
                                    data-href="{{action('App\Http\Controllers\AccountTypeController@create')}}"
                                        ...
                                        @foreach($account_types as $account_type)
                                            <tr class="account_type_{{$account_type->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    {!! Form::open(['url' => action('App\Http\Controllers\AccountTypeController@destroy', $account_type->id), 'method' => 'delete' ]) !!}
                                                    <button type="button" class="btn btn-primary btn-modal btn-xs" 
                                                    data-href="{{action('App\Http\Controllers\AccountTypeController@edit', $account_type->id)}}"
                                                    data-container="#account_type_modal">
                                            ...
                                            @foreach($account_type->sub_types as $sub_type)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {!! Form::open(['url' => action('App\Http\Controllers\AccountTypeController@destroy', $sub_type->id), 'method' => 'delete' ]) !!}
                                                            <button type="button" class="btn btn-primary btn-modal btn-xs" 
                                                        data-href="{{action('App\Http\Controllers\AccountTypeController@edit', $sub_type->id)}}"
                                                        data-container="#account_type_modal">
                                                        <i class="fa fa-edit"></i> @lang( 'messages.edit' )</button>
                                                            <button type="button" class="btn btn-danger btn-xs delete_account_type" >
                                                            <i class="fa fa-trash"></i> @lang( 'messages.delete' )</button>

...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-3 text-right">
            <button data-href="{{action('App\Http\Controllers\ContactController@getLedger')}}?contact_id={{$contact->id}}&action=pdf" class="btn btn-default btn-xs" id="print_ledger_pdf"><i class="fas fa-file-pdf"></i></button>

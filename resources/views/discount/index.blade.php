        ...
        <div class="box-header">
            ...
            @can('brand.create')
            	<div class="box-tools">
                    ...
                    data-href="{{action('App\Http\Controllers\DiscountController@create')}}" 
            	...
            	<table class="table table-bordered table-striped" id="discounts_table">
                    ...
                    <tr>
                        ...
                        <div style="display: flex; width: 100%;">
                            {!! Form::open(['url' => action('App\Http\Controllers\DiscountController@massDeactivate'), 'method' => 'post', 'id' => 'mass_deactivate_form' ]) !!}

                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            ...
                            @if($module['active'] == 1)
                                <form 
                                    action="{{action('App\Http\Controllers\Install\ModulesController@update', ['module_name' => $module['name']])}}" 
                            ...
                            @else
                                <form action="{{action('App\Http\Controllers\Install\ModulesController@update', ['module_name' => $module['name']])}}" 
                                    style="display: inline;" 
                                    method="post"
                                >
                                    @method('PUT')
                        ...
                        <form 
                            action="{{action('App\Http\Controllers\Install\ModulesController@destroy', ['module_name' => $module['name']])}}"
                                style="display: inline;" 
                                method="post"

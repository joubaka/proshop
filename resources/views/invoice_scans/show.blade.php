                ...
                <div class="box box-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-condensed scan-lines">
                            <thead><tr><th>Scanned item</th><th>Matched product *</th><th>Purchase order</th><th>Qty</th><th>Pack</th><th>Invoice unit cost</th><th>VAT %</th><th>Line total</th><th>Proposed sell</th></tr></thead>
                            <tbody>
                            @forelse($scan->lines as $line)
                                ...
                                <tr class="{{ !$line->variation_id ? 'danger' : (($line->confidence ?? 0) < .8 ? 'warning' : '') }}">
                                    ...
                                    <td data-label="Line total"><input class="form-control input-sm" type="number" step="0.01" min="0" name="lines[{{ $line->id }}][line_total]" value="{{ old("lines.{$line->id}.line_total", $line->line_total) }}" required></td>

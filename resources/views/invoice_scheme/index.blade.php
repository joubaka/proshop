          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4>@lang( 'invoice.all_your_invoice_schemes' ) <button type="button" class="btn btn-primary btn-modal pull-right" 
                                data-href="{{action('App\Http\Controllers\InvoiceSchemeController@create')}}" 
              ...
              <div class="tab-pane" id="tab_2">
                <div class="row">
                    <div class="col-md-12">
                        <h4>@lang( 'invoice.all_your_invoice_layouts' ) <a class="btn btn-primary pull-right" href="{{action('App\Http\Controllers\InvoiceLayoutController@create')}}">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="icon-link">
                                <a href="{{action('App\Http\Controllers\InvoiceLayoutController@edit', [$layout->id])}}">

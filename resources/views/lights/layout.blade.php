...
<head>
    ...
    <link rel="stylesheet" href="/lights-assets/portal.css?v=15"><link rel="stylesheet" href="/lights-assets/live-status.css?v=2"><script defer src="/lights-assets/portal.js?v=12"></script>
</head>
<body>
...
@if(request()->routeIs('lights.admin'))<script defer src="/lights-assets/admin.js?v=6"></script>@endif
</body>
</html>

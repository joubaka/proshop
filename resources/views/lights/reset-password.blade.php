...
<section class="panel checkout">
    ...
    <form method="POST" action="{{ route('lights.password.update') }}">@csrf
        ...
        <label>New password<input name="password" type="password" minlength="6" maxlength="72" required autocomplete="new-password"><small>At least 6 characters.</small></label>

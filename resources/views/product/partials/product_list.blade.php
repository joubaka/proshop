    ...
    <tfoot>
        <tr>
            ...
            <div style="display: flex; width: 100%;">
                @can('product.delete')
                    {!! Form::open(['url' => action('App\Http\Controllers\ProductController@massDestroy'), 'method' => 'post', 'id' => 'mass_delete_form' ]) !!}
                ...
                @endcan
                    ...
                    @can('product.update')
                        ...
                        @if(config('constants.enable_product_bulk_edit'))
                            &nbsp;
                            {!! Form::open(['url' => action('App\Http\Controllers\ProductController@bulkEdit'), 'method' => 'post', 'id' => 'bulk_edit_form' ]) !!}
                ...
                &nbsp;
                {!! Form::open(['url' => action('App\Http\Controllers\ProductController@massDeactivate'), 'method' => 'post', 'id' => 'mass_deactivate_form' ]) !!}

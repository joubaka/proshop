	...
	@forelse($medias as $media)
		<tr>
			...
			<td>
				...
				@if(!empty($delete))
					<button type="button" data-href="{{action('App\Http\Controllers\ProductController@deleteMedia', [$media->id])}}" class="btn btn-danger btn-xs delete-media no-print"><i class="fas fa-trash"></i> @lang('messages.delete')</a>
				@endif
			</td>
		</tr>
	@empty

...
@endphp
@can('category.create')
	<button type="button" class="btn btn-sm pull-right btn-primary btn-modal" data-href="{{action('App\Http\Controllers\TaxonomyController@create')}}?type={{$category_type}}" data-container=".category_modal">

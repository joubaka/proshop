...
{!! Form::open(['url' => action('App\Http\Controllers\UserController@updatePassword'), 'method' => 'post', 'id' => 'edit_password_form',
...
{!! Form::close() !!}
{!! Form::open(['url' => action('App\Http\Controllers\UserController@updateProfile'), 'method' => 'post', 'id' => 'edit_user_profile_form', 'files' => true ]) !!}
<div class="row">
    <div class="col-sm-8">
        <div class="box box-solid"> <!--business info box start-->
            <div class="box-header">
